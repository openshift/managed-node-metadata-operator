...
- `managed-node-metadata-operator-pull-request.yaml`: PR validation
- `managed-node-metadata-operator-push.yaml`: Main branch builds
- `managed-node-metadata-operator-pko-pull-request.yaml`: PKO validation
- `managed-node-metadata-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/managed-node-metadata-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: managed-node-metadata-operator-pull-request
Stage: golangci-lint
Error: Exit code 1
